...
function App() {
  ...
  function JobDetails() {
    return (
      <Routes>
        {data.map(job => (
          <Route key={job.id} path={`/${job.company}`} element={<JobDetail job={job} />} />
        ))}
      </Routes>
    );
  }
  ...
  function JobDetail({ job }) {
    ...
    return (
      <>
        ...
        <div className="topJobDetail" style={switchsDark ? {backgroundColor: '#19202D'} : {backgroundColor: '#FFF'}}>
          <img src={job.logo} alt="" />
          <div className="topJob">

            <h2 className='tobJobDetailh2' style={switchsDark ? {color: '#FFF'} : {color: '#19202D'}}>{job.company}</h2>
            <p className='tobJobDetailP'>{job.company}.com</p>
          </div>
          <a href={job.website}>
          <button style={switchsDark ? {backgroundColor: '#363b41b8', color: '#FFF'} : {backgroundColor: 'rgba(89, 100, 224, 0.1)', color: '#5964E0'}}>
        ...
        <div className='jobDetail' style={switchsDark ? {backgroundColor: '#19202D'} : {backgroundColor: '#FFF'}}>
          ...
          <h2 style={switchsDark ? {color: '#FFF'} : {color: '#19202D'}}>What You Will Do</h2>
        ...
        <div className="jobDetailBottom" style={switchsDark ? {backgroundColor: '#19202D'} : {backgroundColor: '#FFF'}}>
          
          <div className="jobDetailB">
            <div className="jobDetailBottomInfo">
              <h3 style={switchsDark ? {color: '#FFF'} : {color: '#19202D'}}>{job.position}</h3>
              <p>So Digital Inc.</p> 
            </div>   
  ...
  function JobList() {
    ...
    const handleSearch = () => {
      const newFilteredData = data.filter((job) => {
        ...
        const fullTimeMatch = !isFullTime || job.contract.toLowerCase() === 'full time';
    ...
    return (
          ...
          <div className="jobs">
            <div
              className="header"
              style={switchsDark ? { backgroundColor: '#19202D'} : { backgroundColor: '#FFF' }}
            >
              <div className="header-left">
                ...
                <input
                  ...
                  style={switchsDark ? { backgroundColor: '#19202D', color: '#FFF'  } : { backgroundColor: '#FFF' }}
                  value={titleFilter}
            ...
            >
              ...
              <Modal 
                  ...
                  className="modal"
                  style={{content: switchsDark ? { backgroundColor: '#19202D', borderRadius: '6px'} : { backgroundColor: '#FFF', borderRadius: '6px'}}}
            ...
            {filteredData.slice(0, visibleJobs).map((job) => (
              <Link to={`/${job.company}`} key={job.id}  >
                <div className="job" style={switchsDark ? {backgroundColor: '#19202D'} : {backgroundColor: '#FFF'}}>
                  ...
                  <p className='position' style={switchsDark ? { color: '#FFF' } : { color: '#19202D' }}>{job.position}</p>
